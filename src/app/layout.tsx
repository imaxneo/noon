      ...
      <body className={`${cairo.variable} font-sans antialiased`}>
        ...
        <ThemeProvider>
          ...
          <BannerAd
            ...
            inlineScript={`(function(d,z,s,c){s.src='//'+d+'/400/'+z;s.onerror=s.onload=E;function E(){c&&c();c=null}try{(document.body||document.documentElement).appendChild(s)}catch(e){E()}})('stoampaliy.net',9828201,document.createElement('script'),_xfbhash)`}
          />
          <OnclickAd
